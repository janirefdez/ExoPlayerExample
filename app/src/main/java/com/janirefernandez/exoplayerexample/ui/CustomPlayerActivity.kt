...
import com.janirefernandez.exoplayerexample.databinding.ActivityCustomPlayerViewBinding
...
class CustomPlayerActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCustomPlayerViewBinding
    private var exoPlayer: ExoPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCustomPlayerViewBinding.inflate(layoutInflater)
